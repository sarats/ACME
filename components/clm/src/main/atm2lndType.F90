module atm2lndType
  ...
  type, public :: atm2lnd_type
     ...
     real(r8), pointer :: forc_ndep_nh3x_grc            (:)   => null() ! nitrogen deposition rate (gN/m2/s)
     real(r8), pointer :: forc_ndep_noy_grc             (:)   => null() ! nitrogen deposition rate (gN/m2/s)
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%forc_ndep_nh3x_grc            (begg:endg))        ; this%forc_ndep_nh3x_grc            (:)   = ival
    allocate(this%forc_ndep_noy_grc             (begg:endg))        ; this%forc_ndep_noy_grc             (:)   = ival
